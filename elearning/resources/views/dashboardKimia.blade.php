    ...
    <x-app-layout>
        ...
        <x-slot name="header">
            <h2 class="font-semibold text-xl text-gray-500 leading-tight">
                {{ __('E-Learning | Kimia  Kamis 8:00 - 10:00') }}
            </h2>
        </x-slot>
        ...
        <div style="background-color: #FFFF">
            ...
            <section class="container" style="padding-left: 80px;">
                <div style="display: flex; padding-left: 100px; padding-top: 100px; padding-right : 100px"">
                    <div style="flex: 1;">
                        <a href="{{ Route('dashboard.filekimia') }}">
                            <div class="card-body">
                                <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
                                    <p style="padding: 20px; border-radius: 8px; ">
                                        Tugas 1 | Menghitung Atom Natrium
                                    </p>
                                </div>
                        ...
                        <p style="text-decoration: underline; padding-top: 20px">
                            <a href="{{ Route('dashboard.filekimia') }}"> Silahkan buatlah tugas berikut kerjakan format
                                pdf.</a>
