        ...
        <div class="w-full flex justify-between">
            <div class="">
                <h2 class="font-semibold text-xl text-gray-500 leading-tight">
                    {{ __('E-Learning | Management Mata Pembelajaran') }}
                </h2>
            </div>
        </div>
    </x-slot>
            ...
            <div id="myModal" class="modal">
                <div class="modal-content md:w-1/5">
                    <form action="{{ Route('subject.store') }}" method="POST">
                        ...
                        <div class="pmd:px-20 md:py-10 gap-2">
                            ...
                            <div class="mt-2" style="">
                                <label for="id" class="block font-bold">Hari <span
                                        class="text-red-500">*</span></label>
                                <select name="day" id="" class="w-full" required>
                            ...
                            <div class="mt-2" style="">
                                <label for="id" class="block font-bold">Jam Mulai <span
                                        class="text-red-500">*</span></label>
                                <input class="w-full" type="time" name="time_start" id="" required>
                            </div>
                            <div class="mt-2" style="">
                                <label for="id" class="block font-bold">Jam Berakhir <span
                                        class="text-red-500">*</span></label>
                                <input class="w-full" type="time" name="time_end" id="" required>
                            </div>
                            <div class="mt-2" style="">
                                <label for="id" class="block font-bold">Kode Kelas <span
                                        class="text-red-500">*</span></label>
                                <select name="grade_id" class="w-full" id="" required>
                            ...
                            <div class="mt-2" style="">
                                <label for="id" class="block font-bold">Kode Guru <span
                                        class="text-red-500">*</span></label>
                                <select name="teacher_id" class="w-full" id="" required>
                        ...
                        <div class="flex justify-center w-full mt-5 gap-2">
