    ...
    <div class="w-full flex justify-center">
        <div class="md:w-[28%] mt-6 px-20 py-10 bg-white md:shadow-md overflow-hidden sm:rounded-lg">
            ...
            <div class="row flex justify-center items-center">
                <div class="profile-pic pt-4" style="width: 10rem;">
            ...
            <form method="POST" action="{{ route('register') }}" class="w-full">
                ...
                <!-- Name -->
                <div>
                    <h1 class="text-[2.5rem] font-bold" style="text-align : center;">Regi<span>ster</span></h1>
                    <br>
                ...
                <x-primary-button class="ml-4 text-center" class="btn btn-primary mt-6">
                    {{ __('Register') }}
                </x-primary-button>
                <br>
            </form>
