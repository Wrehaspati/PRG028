            ...
            <div class="flex justify-between">
                <div style="" class="">
                    ...
                    <div class="mt-5 md:ml-16 gap-4 flex w-full md:justify-start justify-center pb-20">
                        <a href="{{ route('login') }}" class="no-underline button bg-green-500 hover:bg-green-700 text-white px-5 py-2 rounded shadow">Masuk</a>
                        <a href="{{ route('register') }}" class="no-underline button bg-cyan-500 hover:bg-cyan-700 text-white px-5 py-2 rounded shadow">Daftar</a>
                    </div>
                </div>
                <div class="profile-pic hidden lg:block pr-40 py-20 w-[40%]">
                    <img src="https://ouch-cdn2.icons8.com/OQ3yuVTnKqAb4khnDpO7_KBTgYEZFOxQQSTIg3787mg/rs:fit:256:458/czM6Ly9pY29uczgu/b3VjaC1wcm9kLmFz/c2V0cy9wbmcvOTYz/L2Q3ZTAzZDAzLWIw/MGQtNDgyMi05OWQ1/LTMxMmVhMTJkNTY3/My5wbmc.png" class="w-[16rem]">
                </div>
            </div>
